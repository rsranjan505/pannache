...
@section('content')
<section class="hero-section jarallax d-flex align-items-center justify-content-center padding-medium pb-5" style="background: url({{ asset('assets/img/portfolio.jpg')}}) no-repeat;">
